...
- PowerApps
- D365CE
ms.openlocfilehash: ab069de0707647c48d34036e12e5c55bd7acc0f1
ms.sourcegitcommit: 4b6f187c9501332f9acca5978fa326621f2980e5
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 05/22/2020
ms.locfileid: "3394508"
---
...
2. **フィールド** タブでは、次のビューを選択できます。 

 |ビュー|説明|
 |--|--|
 |**すべて**| エンティティのすべてのフィールドを表示する|
 |**マネージド**| エンティティのマネージド フィールドと標準フィールドのみを表示する|
...
フィールドを表示する際に、コマンド バーで **フィールドの追加**を選択すると、**フィールド プロパティ** パネルが表示されます。
...
|**検索**| 単一のターゲット レコード タイプの単一レコードへの参照を作成します。|
...
**表示名**、**名前**、**データの種類** プロパティを設定後は、**完了** を選択して**フィールド プロパティ** パネルを閉じることができます。 

エンティティの編集を続けて、追加のフィールドを追加したり、戻ってこのフィールドを編集し続けることができます。 フィールドは、エンティティへのすべての変更を保存するため、 **エンティティを保存する** を選択するまで作成されません。

![[エンティティの保存] ボタン](media/save-entity-button.png)

**破棄** を選択して、ユーザーが行った変更を破棄することもできます。
...
ローカル オプション セットを作成する場合、**詳細を表示** を選択して **ローカル オプション セット** を選択する必要があります。
