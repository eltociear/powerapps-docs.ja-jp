...
description: デジタルで距離を測定し、Power Apps の拡張現実機能を使用して現実世界のエリアと形状を作成します。
author: iaanw
manager: shellyha
...
search.app:
- PowerApps
ms.openlocfilehash: 37df25066284ca8cff6e7af1cc401b76d1065973
ms.sourcegitcommit: a5b3871e623cebd7de64a0c386503832a2d04c03
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 05/04/2020
ms.locfileid: "3331694"
---
