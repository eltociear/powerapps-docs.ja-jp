...
- PowerApps
- D365CE
ms.openlocfilehash: 68e834487a33bb1345a2fbe46c2f6dc55532d961
ms.sourcegitcommit: b5ab419dad4e9d64a5e6610641363b0d7487930a
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/19/2020
ms.locfileid: "3465685"
---
...
6.  **メイン** フォームタイプである、 **対話型エクスペリエンス の取引先企業** のレコードを選択します。 **対話型エクスペリエンスの取引先企業** のフォームが新規ブラウザ ウィンドウで開きます。
   ...
   | インシデント (サポート案件) | 対話型エクスペリエンスのサポート案件 <br><br> **注意**: インシデント (ケース) エンティティは、環境に Dynamics 365 Customer Service が含まれている場合にのみ使用できます。|
...
10. リストからオプションを選択して、**データ** コンテナの **アクティビティの並べ替え** オプションを選択します。 たとえば、**最終更新**オプションを選択します。
...
11. 以下を、**追加オプション** コンテナで指定します。
    ...
    | カード フォームの選択 | リストからカード フォームを選択します。  <br><br> **注意:** このフィールドは、**カード フォーム**を**活動の表示方法**フィールドのために選択した場合のみ現れます。 <br><br> 各アクティビティを選択し、対応するカード フォームを選択して使用します。 選択した各アクティビティと対応するカード フォームは、選択すると自動的に保存されます。 | 電子メール カード フォーム |
