...
ただし、重要な情報が切り捨てられたり、表示されなくなったりすることが発生しやすいことが想定されます。 低密度ヘッダーでは、ヘッダーに表示されるフィールド値だけでなく、レコードのタイトルも切り捨てられます。 多くの場合、ヘッダーに1つから2つのフィールドのみが表示されますが、残りのフィールドは表示されずポップアップに格納されます。この表示しきれない部分を表示するには、余分なクリックをする必要があります。
