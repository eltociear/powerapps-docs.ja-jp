...
- PowerApps
- D365CE
ms.openlocfilehash: 91aaed33ed5fcec9c2d8b1544c578bfda39ccf28
...
---
# <a name="custom-controls-available"></a>利用可能なカスタム コントロール 

豊富に用意された追加のコントロールを使用することで、よりタッチ操作に適したエクスペリエンスを実現できます。 これらには、スライダー、スイッチ、マルチメディア プレーヤー、定型入力、カレンダー、およびその他のコントロールが含まれます。  
...
4.  目的のコントロールを選択し、**追加**を選択します。  
  
    > [!NOTE]
    >  フィールドまたは一覧の種類に応じて、さまざまなコントロールを使用できます。 たとえば、スライダーコントロールは、数値フィールドや金額フィールドでのみ使用できる場合があります。  
  
5.  コントロールを表示するデバイスを選択します。 コントロールは、電話のヘッダー フィールドでは使用できません。  
  
6.  各プロパティの値を構成します。  
  
7.  コントロールの構成が完了したら、**OK** を選択します。  
...
[チュートリアル: カスタム コントロールを使用したデータのビジュアル化](use-custom-controls-data-visualizations.md)</br>
