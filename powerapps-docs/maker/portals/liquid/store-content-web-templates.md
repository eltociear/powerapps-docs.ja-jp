...
ms.author: gisingh
ms.reviewer: tapanm
ms.openlocfilehash: 2e69170a0b77fe7ad9314c97ae4eeef78a6d2641
ms.sourcegitcommit: c12260f372ad2cc48d3146be570d2088c9ef1d86
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/20/2020
ms.locfileid: "3491092"
---
# <a name="store-source-content-by-using-web-templates"></a>Web テンプレートを使用したソース コンテンツの保存

Web テンプレートは、テンプレート ソース コンテンツの保存に使用される Power Apps ポータルに含まれる Power Apps エンティティ (adx\_webtemplate) です。 Web テンプレートは一般的に、動的なコンテンツの表示のために Liquid を含み、Liquid テンプレートを残りの Power Apps ポータル システムに統合するのに使用される中央のエンティティです。
...
|  [ソース]   |                                  テンプレートのソース コンテンツ。 Power Apps では、構文ハイライトを含むソース・コード エディターおよび他のコード編集機能がこのフィールドに提供されます。                                  |
...
Web テンプレートは、Power Apps ポータルのコンテンツ管理システムに新しいテンプレートを作成するためにページ テンプレートと組み合わせて使用できます。 これは、.NET コードを作成したりポータル アプリケーションを再展開することなく、完全に Power Apps 内で実行できます。
...
Web テンプレートは一般的に HTML の表示に使用され、すべての応答をレンダリング (**Web サイト ヘッダーとフッターの使用**を選択解除) することでオプションとしてテキストベースのフォーマットをレンダリングすることができます。 ここで、Web テンプレートの **MIME の種類**属性が有効になります。 Web サイトのヘッダーとフッターを使用しないページ テンプレートを表示すると、HTTP 応答コンテンツ タイプ ヘッダーが関連付けられている Web テンプレートの MIME の種類に設定されます。 (MIME の種類が指定されていない場合、text/html が使用されます。) これにより、Liquid を使用して非 HTML のコンテンツを表示するさまざまなオプションが用意されます。 一般的には、MIME の種類を application/rss+xml に設定することで [RSS](https://en.wikipedia.org/wiki/RSS) フィードの表示に使用されます。  

## <a name="web-templates-as-website-headers-and-footers"></a>Web サイトのヘッダーおよびフッターとしての Web テンプレート

Web テンプレートは、Power Apps ポータルが使用するグローバル ヘッダーおよびフッターを上書きするのにも使用できます。 これを行うには、Web サイトの**ヘッダー テンプレート**または**フッター テンプレート**フィールドを任意の Web テンプレートに設定します。 **Web サイト ヘッダー**を上書きすると、既定のヘッダー テンプレートにより通常処理されるインターフェイス要素である、サイトのプライマリ ナビゲーション、サインイン/サインアウト用リンク、検索インターフェイスなどの表示が選択したテンプレートにより行われることに注意します。

## <a name="built-in-web-templates"></a>組み込み Web テンプレート

Power Apps ポータル内で使用できる一連の作成済み Liquid テンプレートがあります。 それらを使用するには、参照として下記のリストを使用してそれらを名前別に含める必要があります。
