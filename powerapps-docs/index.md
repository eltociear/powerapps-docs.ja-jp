...
ms.custom:
- PowerApps-hub
ms.openlocfilehash: 512bcc7c9ffeb8cb8ec92ff029a6cc75f3646cf8
ms.sourcegitcommit: a2b5f47d66f04bce013232f053164d411fa19110
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/01/2020
ms.locfileid: "3529812"
---
<div id="main"
   class="v2">
   <div class="container">
      ...
      <ul class="pivots">
         <li>
            ...
            <ul id="home">
               <li>
                  <a href="#getstarted"><strong>作業の開始</strong></a>
                  <ul id="getstarted"
                     class="cardsC">
                     <br/>                            
                     <li class="fullSpan">
                                 ...
                                 <div class="cardSize">
                                    <div class="cardPadding">
                                       <div class="card">
                                          ...
                                          <div class="cardText">
                                             <h3>ブログ</h3>
                                             <p>公式の Power Apps ブログを参照して、Power Apps に関する最新の機能とお知らせを把握します。</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/open-app-embedded-in-teams">Microsoft Teams で (キャンバス アプリ)</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/create-a-record">レコードを作成する</a></p>
               ...
               <li>
                  ...
                  <ul id="maker"
                     ...
                     <li>
                        <div class="container">
                           <p>アプリ作成者は、コードを記述せずにカスタム ビジネス アプリをすばやく作成することによって、組織のミッション クリティカルなデータを管理できます。 Power Apps では、<strong>キャンバス アプリ</strong>、<strong>モデル駆動型アプリ</strong>、そして<strong>ポータル</strong>の 3 種類のアプリを作成できます。 <strong>Common Data Service</strong> は、ビジネス アプリで使用されるデータを安全に格納し、管理することができるデータ プラットフォームです。 詳細: <a href="/powerapps/guidance/planning/introduction">Power Apps プロジェクトの作成</a>と<a href="/powerapps/maker">アプリの作成</a>。</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                              ...
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <ul>
                                       ...
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/add-configure-controls">インターフェイスの設計</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/working-with-formulas">アプリの機能の構成</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/edit-app">アプリの管理</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/share-app">アプリの共有</a></p>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/use-custom-controls-data-visualizations">カスタム コントロールの使用</a></p>                                    
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/share-model-driven-app">アプリの共有</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/distribute-model-driven-app">アプリの配布</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/portals/create-portal">ポータルの作成</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/portals/manage-existing-portals">既存のポータルの管理</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/portals/admin/admin-overview">ポータル管理</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/why-cds-overview">Common Data Service を選ぶ理由</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/cds-processes">ビジネス ロジックの適用</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/solutions-overview">ソリューション</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/wp-security">Common Data Service でのセキュリティ</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/alm/">Power Platform ALM ガイド</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/environments-overview">環境の概要</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/trial-environments">試用版環境</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/database-security">環境のセキュリティ</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/dev-appsource-test-drive">AppSource でのお客様によるキャンバス アプリ体験版の使用</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/client-scripting">クライアント スクリプトを使用したビジネス ロジックの適用</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/component-framework/overview">カスタム コンポーネントを構築する (Power Apps component framework)</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">ビジネス ロジックの適用</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/alm/solution-concepts-alm">ソリューションの概念</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/alm/devops-build-tools">Microsoft Power Platform Build Tools (Azure DevOps 用)</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/alm/solution-packager-tool">SolutionPackager ツール</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/alm/package-deployer-tool">Package Deployer ツール用のパッケージの作成</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/alm/checker-api/overview">Power Apps Checker Web API を使用する</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/powerapps-cli">Power Apps CLI の取得</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">参照</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/webapi/quick-start-console-app-csharp">クイック スタート: Web API のサンプル</a></p>
